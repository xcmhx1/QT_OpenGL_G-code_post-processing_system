...
void GProfileDialog::applyTheme()
{
    ...
    (
        ...
        (
            ...
            "padding: 4px;"
            "}"
            "#GProfileDialog QLineEdit:focus,"
            "#GProfileDialog QComboBox:focus,"
            "#GProfileDialog QListWidget:focus,"
            "#GProfileDialog QPlainTextEdit:focus { border-color: %8; }"
            ...
            "background-color: %11;"
            "}"
            "#GProfileDialog QDialogButtonBox QPushButton:default {"
            "background-color: %8;"
            "color: %9;"
            "border-color: %8;"
            "font-weight: 600;"
