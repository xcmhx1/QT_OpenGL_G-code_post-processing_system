...
- 空闲态动态命令框已接通以下常用命令入口：`line`、`xline`、`rectangle`、`polygon`、`point`、`circle`、`arc`、`ellipse`、`polyline`、`lwpolyline`、`move`、`delete`、`color`、`fit`、`top`、`zoomin`、`zoomout`
