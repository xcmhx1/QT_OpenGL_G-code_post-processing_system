...
QString diagnosticCodeName(DiagnosticCode code)
{
    ...
    case DiagnosticCode::ProcessPlanningEntrySelectionSummary: return QStringLiteral("ProcessPlanningEntrySelectionSummary");
    ...
    case DiagnosticCode::ProcessPlanningZone16SweepSummary: return QStringLiteral("ProcessPlanningZone16SweepSummary");
    ...
    case DiagnosticCode::ProcessPlanningOwnerZoneEntryUnavailable: return QStringLiteral("ProcessPlanningOwnerZoneEntryUnavailable");
    ...
    case DiagnosticCode::MachineTrajectoryTransferPreviewMismatch: return QStringLiteral("MachineTrajectoryTransferPreviewMismatch");
