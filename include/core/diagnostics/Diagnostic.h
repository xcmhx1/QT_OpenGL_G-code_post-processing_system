...
enum class DiagnosticCode
{
    ...
    ProcessPlanningZoneIncomplete,
    ProcessPlanningBreakStartSummary,
    ProcessPlanningBreakExitZoneUnresolved,
    ProcessPlanningBreakPartitionMappingMissing,
    ProcessPlanningBreakPartitionStartFailed,
    ProcessPlanningBreakMidpointCandidateMissing,
    ProcessPlanningBreakFragmentTraversalInvalid,
