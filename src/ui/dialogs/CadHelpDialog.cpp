...
<li>点击一次“清理内部线条”，系统在截面中心生成 YZ 内缩窗口：按最大圆角半径内缩，并附加额外安全内缩。</li>
<li>完整位于窗口内的图元会被物理删除；删除进入统一撤销栈，可按 Ctrl+Z 整体恢复。</li>
<li>接触窗口、安全带附近或位于方管表面的图元会保留；加工断面和废面图元不会删除。</li>
<li>右键“内部线条 -> 内部线条指定/恢复”可手动标记：被标记图元只排除加工、不删除，并可单独恢复。</li>
</ul>
<h2>加工断面与废面</h2>
<ul>
<li>加工断面和废面都要求有效方管截面，并且候选图元必须形成严格闭环。</li>
<li>加工断面是工艺屏障：断面之前所属加工段的普通内容先完成，再加工该断面。</li>
<li>可从画布右键菜单指定、恢复加工断面，或自动清理、手动标记内部线。</li>
</ul>
<h2>四轴工艺参数</h2>
<table>
