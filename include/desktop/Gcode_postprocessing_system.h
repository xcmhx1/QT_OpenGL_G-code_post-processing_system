...
#include "ui/widgets/CadCommandLineWidget.h"
...
private:
    ...
    bool loadAutoDeduplicateOnImport() const;
    ...
    void runDxfImportPostProcessing();
    ...
    bool removeDuplicateEntities(bool interactive = true);
